...
export default function ProfilePage() {
  ...
  const [theme, setTheme] = useState<string>(
    dummyData.additionalInfo.personal.theme
  ); // Theme state
  ...
  const activeSocialLinks = Object.entries(
    profileData?.socialMediaInfo || dummyData.socialMediaInfo
  )
      ...
      >
        ...
        <div style={{ flex: 1, position: "relative" }}>
          ...
          <div
            ...
            style={{
              ...
              // backgroundImage: `url(${
              //   bgImage || dummyData.additionalInfo.personal.background_image
              // })`,
              backgroundSize: "cover",
              backgroundPosition: "center",
              ...
              >
                ...
                >
                  {profileData?.additionalInfo.personal.fullname ||
                    dummyData.additionalInfo.personal.fullname}
                </h1>
                <p
                  style={{
                    margin: "5px 0",
                ...
                >
                  {profileData?.additionalInfo.personal.designation ||
                    dummyData.additionalInfo.personal.designation}
                </p>
                <p
                  style={{
                    margin: 0,
                ...
                >
                  {profileData?.additionalInfo.personal.description ||
                    dummyData.additionalInfo.personal.description}
                </p>
              </div>
            </div>
              ...
              >
                {profileData?.contactInfo.email && (
                  <button
                    ...
                    className={`
                        gap-2 text-black backdrop-blur-sm bg-transparent
              w-full h-12 flex items-center p-4  border-2 rounded-md
              ${
        ...
        {isModalOpen && (
          ...
          >
            <img
              src={
                profileImage || dummyData.additionalInfo.personal.profile_image
              }
              alt="Profile Preview"
              style={{
                maxWidth: "90%",
